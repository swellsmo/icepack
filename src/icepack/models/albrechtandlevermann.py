...
class DamageTransportAL(TransportEquation):
    def __init__(
        self,
        damage_stress=0.07,
        damage_rate=0.3,
        ...
        keys = ("damage_stress", "damage_rate", "healing_strain_rate", "healing_rate")
        damage_stress, damage_rate, healing_strain_rate, healing_rate = itemgetter(*keys)(kwargs)

      
        super(DamageTransportAL, self).__init__(
