...
class DamageTransport(TransportEquation):
    ...
    def sources(self, **kwargs):
     ...
     #    keys2 = ("healing_strain_rate", "damage_stress", "healing_rate", "damage_rate")
     #    ε_h, σ_d, γ_h, γ_d = itemgetter(*keys2)(kwargs)
        ...
        ε_h = kwargs.get("healing_strain_rate",firedrake.Constant(self.healing_strain_rate))
        σ_d = kwargs.get("damage_stress",firedrake.Constant(self.damage_stress))
        γ_h = kwargs.get("healing_rate",firedrake.Constant(self.healing_rate))
        γ_d = kwargs.get("damage_rate",firedrake.Constant(self.damage_rate))
